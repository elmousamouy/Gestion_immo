      ...
      <tbody id="class">
        ...
        <tr id="sid <?php echo e($bien->id); ?> ">
          <td class="text-right text-nowrap pr-4font-weight: bold;" > <?php echo e($bien->id); ?></td>
            ...
            <!--Amortissement--->
            <?php if($bien->duree_ammortissement>0): ?>
            <td class="text-right text-nowrap pr-4font-weight: bold;"><?php echo e(((100/($bien->duree_ammortissement))*($bien->prix_achat)/100)); ?></td>
            <?php else: ?> <td class="text-right text-nowrap pr-4font-weight: bold;">0</td>
            <?php endif; ?>
...
<?php /**PATH /var/www/html/Gestion_immo/resources/views/Bien/table.blade.php ENDPATH**/ ?>