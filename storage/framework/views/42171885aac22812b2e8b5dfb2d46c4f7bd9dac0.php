...
<a class="dropbtn ml-5 mr-2" href="<?php echo e(url('/')); ?>" style="border-radius: 3px;">Accueil</a>
            <a class="dropbtn" href="<?php echo e(url('/Biens')); ?>" style="border-radius: 3px; ">Biens</a>
            <?php if(Auth::user()->role_id == 1): ?>
            <a class="dropbtn" href="<?php echo e(url('Users/')); ?>" style="border-radius: 4px; ">Utilisateurs</a>
            <?php endif; ?>
            <div class="dropdownList">
                <a class="dropbtn mr-2" style="border-radius: 4px;padding: 18px 15px;color:white;">Base de donnée <div
                        class="separ"></div><i class="fa fa-caret-down" aria-hidden="true"></i> </a>
                <div class="dropdownList-one" style=" max-width: 150px;">
                    <a class="dItem" href="<?php echo e(url('/Entreprise')); ?>">Filiale</a>
                    <a class="dItem" href="<?php echo e(url('Categorie')); ?>">Categorie</a>
                </div>
            </div>
        </div>
        <div style="float:right;">
            <a style=" color: #f1f3ce;padding:16px;font-size: 14px;" class="text-uppercase"><?php echo e(Auth::user()->name); ?> 
               </a>
            <div class="dropdownList">
    ...
    </div><?php /**PATH /var/www/html/Gestion_immo/resources/views/layouts/main.blade.php ENDPATH**/ ?>