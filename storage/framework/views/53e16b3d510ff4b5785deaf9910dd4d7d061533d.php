...
<div class="form-row "  style="margin-top:100px;">
 <?php if(Auth::user()->entreprise_id == 1 ||Auth::user()->role_id == 1 ): ?>
...
<?php endif; ?>
<?php if(Auth::user()->entreprise_id == 2 ||Auth::user()->role_id == 1 ): ?>
  ...
  <?php endif; ?>
  <?php if(Auth::user()->entreprise_id == 5 ||Auth::user()->role_id == 1 ): ?>
  ...
  <?php if(Auth::user()->entreprise_id == 4 ||Auth::user()->role_id == 1 ): ?>
  <div class="card" style="width: 10rem ; margin:10px !important"><a href="<?php echo e(route('bien.filiale',['entreprise_id'=>4])); ?>"><img class="card-img-top" height="150px" style="width: 10rem10px" src="<?php echo e(asset('img/bics.png')); ?>">
    <div class="card-body">
      <h5 class="card-title">BICS</h5>
    </div></a>
  </div>
  <?php endif; ?>
  <?php if(Auth::user()->entreprise_id == 3 ||Auth::user()->role_id == 1 ): ?>
  <div class="card" style="width: 10rem ; margin:10px !important"><a href="<?php echo e(route('bien.filiale',['entreprise_id'=>3])); ?>"><img class="card-img-top"  height="150px" style="width: 10rem10px" src="<?php echo e(asset('img/LOGO-EV_FR.png')); ?>">
    <div class="card-body">
      <h5 class="card-title">CDP</h5>
    </div></a>
  </div>
  <?php endif; ?>
  <?php if(Auth::user()->entreprise_id == 6 ||Auth::user()->role_id == 1 ): ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Gestion_immo/resources/views/Bien/filiale.blade.php ENDPATH**/ ?>