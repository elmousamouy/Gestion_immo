...
<div class="card" style="background-color: rgb(255, 255, 255)">
  <div class="card-header"><?php echo e(__('CREE Filiale')); ?>  
           
  </div>
  <div class="card-body">
    <div class="table-container">
    <form action="<?php echo e(route('/Entreprise/store')); ?>" method="POST" class="m-5">
      <?php echo csrf_field(); ?>
    <div class="form-row">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gestion_immo\resources\views/Entreprise/create.blade.php ENDPATH**/ ?>