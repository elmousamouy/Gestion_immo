...
<a class="dropbtn ml-5 mr-2" href="{{ url('/') }}" style="border-radius: 3px;">Accueil</a>
            <a class="dropbtn" href="{{ url('/Biens') }}" style="border-radius: 3px; ">Biens</a>
            @if (Auth::user()->role_id == 1)
            <a class="dropbtn" href="{{ url('Users/') }}" style="border-radius: 4px; ">Utilisateurs</a>
            @endif
            <div class="dropdownList">
                ...
                <div class="dropdownList-one" style=" max-width: 150px;">
                    <a class="dItem" href="{{ url('/Entreprise') }}">Filiale</a>
                    <a class="dItem" href="{{ url('Categorie') }}">Categorie</a>
                </div>
            </div>
        </div>
