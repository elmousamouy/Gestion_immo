...
<div class="card" style="width: 10rem ; margin:10px !important"><a href="{{route('bien.filiale',['entreprise_id'=>1])}}"><img class="card-img-top"  height="150px" style="width: 10rem10px" src="{{ asset('img/LOGO-EV_FR.png') }}">
  ...
  <div class="card" style="width: 10rem ; margin:10px !important"><a href="{{route('bien.filiale',['entreprise_id'=>3])}}"><img class="card-img-top" height="150px" style="width: 10rem10px" src="{{ asset('img/bics.png') }}">
    <div class="card-body">
      <h5 class="card-title">BICS</h5>
    </div></a>
  </div>

  <div class="card" style="width: 10rem ; margin:10px !important"><a href="{{route('bien.filiale',['entreprise_id'=>4])}}"><img class="card-img-top"  height="150px" style="width: 10rem10px" src="{{ asset('img/LOGO-EV_FR.png') }}">
    <div class="card-body">
